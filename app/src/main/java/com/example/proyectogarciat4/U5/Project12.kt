...
/**They enter by keyboard two integer values. If the first is less than the second
calculate the addition and subtraction but rather calculate the product and the
division.**/
